<aside class="w-64 bg-white shadow-md flex flex-col justify-between">
    <div>
        ...
        <nav class="mt-6 space-y-2 px-4">
            <!-- Dashboard -->
            <a href="{{ route('dosen.dashboard') }}" class="flex items-center px-3 py-2 bg-blue-100 text-blue-600 rounded-lg font-medium">
            ...
            <a href="{{ route('dosen.riwayat') }}" class="flex items-center px-3 py-2 text-gray-700 hover:bg-gray-100 rounded-lg">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
