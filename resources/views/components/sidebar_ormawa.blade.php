<aside class="w-64 bg-white shadow-md flex flex-col justify-between">
    <div>
        ...
        <nav class="mt-6 space-y-2 px-4">
            <!-- Dashboard -->
            <a href="{{ route('admin.dashboard') }}" class="flex items-center px-3 py-2 bg-blue-100 text-blue-600 rounded-lg font-medium">
            ...
            <a href="{{ route('admin.pengajuan') }}" class="flex items-center px-3 py-2 text-gray-700 hover:bg-gray-100 rounded-lg">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="{{ route('admin.riwayat') }}" class="flex items-center px-3 py-2 text-gray-700 hover:bg-gray-100 rounded-lg">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                </svg>
                Riwayat Dokumen
            </a>
            <p class="text-sm text-gray-500 mt-4 ml-2">Kelola User</p>
            <a href="{{ route("admin.kelola-user") }}" class="flex items-center px-3 py-2 text-gray-700 hover:bg-gray-100 rounded-lg">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
